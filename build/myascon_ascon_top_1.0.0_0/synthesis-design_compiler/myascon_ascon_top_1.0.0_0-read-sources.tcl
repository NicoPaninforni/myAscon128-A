...
analyze -format sverilog -define { } -work work src/myascon_ascon_top_1.0.0_0/rtl/ascon_params.sv
...
analyze -format sverilog -define { } -work work src/myascon_ascon_top_1.0.0_0/rtl/register.sv
analyze -format sverilog -define { } -work work src/myascon_ascon_top_1.0.0_0/rtl/ascon_sbox_d2.sv
analyze -format sverilog -define { } -work work src/myascon_ascon_top_1.0.0_0/rtl/shareCreator.sv
