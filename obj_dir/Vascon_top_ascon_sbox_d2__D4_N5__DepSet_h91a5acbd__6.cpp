...
VL_INLINE_OPT void Vascon_top_ascon_sbox_d2__D4_N5___nba_sequent__TOP__ascon_top__DOT__gen_unsupported__DOT__gen_sbox__BRA__12__KET____DOT__u_sbox__0(Vascon_top_ascon_sbox_d2__D4_N5* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vascon_top_ascon_sbox_d2__D4_N5___nba_sequent__TOP__ascon_top__DOT__gen_unsupported__DOT__gen_sbox__BRA__12__KET____DOT__u_sbox__0\n"); );
    ...
    CData/*4:0*/ __Vfunc_xor_tree__12__in;
    ...
    while (VL_LTS_III(32, __Vfunc_xor_tree__12__unnamedblk8__DOT__i, __Vfunc_xor_tree__12__N)) {
        vlSelfRef.__Vlvbound_h2db25a5e__0 = ((4U >= 
                                              (7U & __Vfunc_xor_tree__12__unnamedblk8__DOT__i)) 
                                             && (1U 
                                                 & ((IData)(__Vfunc_xor_tree__12__in) 
                                                    >> 
                                                    (7U 
                                                     & __Vfunc_xor_tree__12__unnamedblk8__DOT__i))));
        if (VL_LIKELY(((4U >= (7U & __Vfunc_xor_tree__12__unnamedblk8__DOT__i))))) {
            vlSelfRef.__Vfunc_xor_tree__12__stage[0U] 
                = (((~ ((IData)(1U) << (7U & __Vfunc_xor_tree__12__unnamedblk8__DOT__i))) 
                                                      ...
                                                      & (vlSelfRef.__Vfunc_xor_tree__12__stage
                                                         ...
                                                         (7U 
                                                          & ((IData)(1U) 
                                                             + 
                                                             VL_MULS_III(32, (IData)(2U), vlSelfRef.__Vfunc_xor_tree__12__unnamedblk9__DOT__i)))))));
            if (VL_LIKELY(((4U >= (7U & vlSelfRef.__Vfunc_xor_tree__12__unnamedblk9__DOT__i))))) {
                vlSelfRef.__Vfunc_xor_tree__12__stage[(3U 
                                                       & ((IData)(1U) 
                                                          + __Vfunc_xor_tree__12__level))] 
                    = (((~ ((IData)(1U) << (7U & vlSelfRef.__Vfunc_xor_tree__12__unnamedblk9__DOT__i))) 
                        & vlSelfRef.__Vfunc_xor_tree__12__stage
                        [(3U & ((IData)(1U) + __Vfunc_xor_tree__12__level))]) 
                       | (0x1fU & ((IData)(vlSelfRef.__Vlvbound_h593c59e9__0) 
                                   << (7U & vlSelfRef.__Vfunc_xor_tree__12__unnamedblk9__DOT__i))));
            }
                                                 ...
                                                 && (1U 
                                                     & (vlSelfRef.__Vfunc_xor_tree__12__stage
                                                        ...
                                                        (7U 
                                                         & (__Vfunc_xor_tree__12__num 
                                                            - (IData)(1U))))));
            if (VL_LIKELY(((4U >= (7U & VL_DIVS_III(32, __Vfunc_xor_tree__12__num, (IData)(2U))))))) {
                vlSelfRef.__Vfunc_xor_tree__12__stage[(3U 
                                                       & ((IData)(1U) 
                                                          + __Vfunc_xor_tree__12__level))] 
                    = (((~ ((IData)(1U) << (7U & VL_DIVS_III(32, __Vfunc_xor_tree__12__num, (IData)(2U))))) 
                        & vlSelfRef.__Vfunc_xor_tree__12__stage
                        [(3U & ((IData)(1U) + __Vfunc_xor_tree__12__level))]) 
                       | (0x1fU & ((IData)(vlSelfRef.__Vlvbound_h4fe11655__0) 
                                   << (7U & VL_DIVS_III(32, __Vfunc_xor_tree__12__num, (IData)(2U))))));
            }
    ...
    __Vfunc_xor_tree__12__Vfuncout = (1U & vlSelfRef.__Vfunc_xor_tree__12__stage
                                      [(3U & __Vfunc_xor_tree__12__level)]);
    __Vlvbound_h163b5fa0__0 = __Vfunc_xor_tree__12__Vfuncout;
